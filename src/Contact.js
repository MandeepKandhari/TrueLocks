...
onInputMessageChange=(event)=>this.setState(Object.assign(this.state.input,{message:event.target.value}))
	...
	render(){
		...
		<section>
					...
					<section className='w-90 ph3 pv2-l pv1-m pv0 mv2-l mv1 flex-l flex-wrap justify-center items-center'>
						<div className='w-50-l w-80 bw1 center'>
							...
							<div className='flex flex-column'>
								<p className='tl mb0 mh2 pv2-l pv1-m pv0 fw6 f4-l f5-m f6 tc-l tl'>Inderjit, T.C.P.L</p>
								<p className='tl mv1-l mv1-m mv0 mh2 pv2-l pv1-m pv0 f4-l f5-m f6 fw6 tc-l tl'>647-830-8783</p>
							</div>
						</div>
						<div className='w-50-l w-80 bw1 center mv2'>
							...
							<div className='flex flex-column'>
								<p className='tl mb0 mh2 f4-l f5-m f6 fw6 tc-l tl'>72 Dolphin Song Crescent</p>
								<p className='tl mb0 mh2 f4-l f5-m f6 fw6 tc-l tl'>Brampton, ON</p>
								<p className='tl mb1 mh2 f4-l f5-m f6 fw6 tc-l tl'>L6R 2A4</p>
							</div>	
						</div>
					</section>	
					<section className='w-90 ba bw1 mb4 google-maps'>
			...
			<article className="br4 mv3 shadow-5 ba b--black dark-gray w-90 w-60-m w-30-l flex flex-column justify-center items-center flip-in-hor-bottom">
		      	<main className="pa2 black-80 w-80">
		        	<div className="measure">
		        		<fieldset className="w-100 ba b--transparent">
		        			<legend className=" mt3 f2-l f3-m f4 fw6 w-100 tc center">Message Form</legend>
			        		<div className="mv3-l mv2-m mv1">
			        			<label  htmlFor='name' className='db fw6 flex items-start f4 w-100'><span className='pl2'>Name</span></label>
								<input className='pa3 ba b--black bg-transparent w-100' 
								type='text' 
			          		...
			          		<div className="mv3-l mv2-m mv1">
			          			<label htmlFor='phone' className='db fw6 flex items-start f4 w-100'><span className='pl2'>Phone Number</span></label>
								<input className='pa3 ba b--black bg-transparent w-100' 
								type="tel" 
							...
							<div className="mv3-l mv2-m mv1">
								<label htmlFor='message' className='db fw6 flex items-start f4 w-100'><span className='pl2'>Message</span></label>
								<textarea 
								className='pa3 ba b--black bg-transparent w-100' 
							...
							<div className="mt4-l mt3-m mt2 mb2-l mb1-m mb0">
								<button 
								className='b ph3 w-40-l w-50 tc pv2 input-reset ba b--black bg-transparent grow pointer fw5 f4 dib' 
								type='submit'
			...
			<h4 className='flex justify-center items-center mh2 ph2 f4-l f5'>Follow us on: 
					<span className='f2 dim mh3 pointer'><FontAwesomeIcon className='fa-lg insta' icon={['fab', 'instagram']} /></span>
					<span className='f2 dim mh3 pointer'><FontAwesomeIcon className='fa-lg fb' icon={['fab', 'facebook-square']} /></span>
				</h4>
		</section>
		</div>
	</section>
